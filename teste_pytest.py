...
class TestCursos:
    headers = {
        'Authorization': 'Token 8a6344e4b2b696f1189cae63d7b8c5fd812f96fa'
    }
    ...
    def test_get_curso(self):
        resposta = requests.get(url=f'{self.url_base_cursos}12/',
    ...
    def test_put_curso(self):
        ...
        resposta = requests.put(url=f'{self.url_base_cursos}12/',
                                headers=self.headers,
                                data=atualizado)
    ...
    def test_delete_curso(self):
        resposta = requests.delete(url=f'{self.url_base_cursos}12/',
                                   headers=self.headers)
